...
namespace Server
{
	public class SeedData
	{
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            EnsureUser(userMgr, "angella", "angella.freeman@email.com", "Pass123$", new Claim[]
            {
        ...
        new Claim(JwtClaimTypes.Role, "user")
            ...
            EnsureUser(userMgr, "john", "john.doe@email.com", "Pass123$", new Claim[]
            {
        ...
        private static void EnsureUser(UserManager<IdentityUser> userManager, string username, string email, string password, Claim[] claims)
        {
